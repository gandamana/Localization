...
void AMCL::update(){
    ...
    // static geometry_msgs::Quaternion best_particle; //hkm
    static bool first = true;
    
    // std::cout << "BP = " << best_particle << std::endl; //kosongggg

    // std::cout << particles_state_.size() << std::endl;
    // std::cout <<"odo x: "<< odometer_out_.x << std::endl;
    // std::cout <<"odo y: " <<  odometer_out_.y << std::endl;
    // std::cout <<"odo theta: " << odometer_out_.theta << std::endl;
    std::cout << "feature size amcl: " <<features_present_ << std::endl;
    sampleMotionModelOdometry(particles_state_, odometer_out_);

    if(features_present_ > 0){
//         // ROS_INFO("features_present_"); //masuk tapi mokad lgsg
        float weight_avg = .0f;
...
//         //-----------------------Start HKM-------------
//         // double max_weight = 0;
//         // for(auto& particle : particles_state_){
//         //     if(particle.w > max_weight){
//         //         max_weight = particle.w;
//         //         best_particle.x = particle.x;
//         //         best_particle.y = particle.y;
//         //         best_particle.z = particle.z;
//         //         best_particle.w = particle.w;
//         //     }
//         // }
//         //-----------------------END HKM-------------
